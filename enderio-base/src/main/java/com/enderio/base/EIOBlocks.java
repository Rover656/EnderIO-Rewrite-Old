...
public class EIOBlocks {
    ...
    public static final BlockEntry<PaintedSlabBlock> PAINTED_SLAB = REGISTRATE.block("painted_slab", PaintedSlabBlock::new).blockstate((ctx, prov) -> {}).initialProperties(() -> Blocks.OAK_SLAB).properties(BlockBehaviour.Properties::noOcclusion).lang("Painted Slab").item(PaintedSlabBlockItem::new).build().register();
