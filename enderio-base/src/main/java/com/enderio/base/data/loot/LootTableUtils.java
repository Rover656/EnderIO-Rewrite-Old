            ...
            LootTable.lootTable()
                    ...
                    new LootPool.Builder().add(
                        LootItem.lootTableItem(block)
                            ...
                            .when(InvertedLootItemCondition.invert(
                                new LootItemBlockStatePropertyCondition.Builder(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(
                ...
                new LootPool.Builder().add(
                    LootItem.lootTableItem(block)
                        ...
                        .when(InvertedLootItemCondition.invert(
                            new LootItemBlockStatePropertyCondition.Builder(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(
                                SlabBlock.TYPE, SlabType.BOTTOM))
                            )
                        )
                )
            )
