	...
	public static void randomTeleport(LivingEntity entity, double range) {
		if (!entity.level.isClientSide) {
	         ...
	         for(int i = 0; i < 16; ++i) {
	            ...
	            double d4 = Mth.clamp(entity.getY() + (entity.getRandom().nextDouble()) * range/2.0D, (double)entity.level.getMinBuildHeight(), (double)(entity.level.getMinBuildHeight() + ((ServerLevel)entity.level).getLogicalHeight() - 1));
