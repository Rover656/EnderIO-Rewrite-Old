...
public class ResettingLeverBlock extends LeverBlock {
  ...
  public InteractionResult use(BlockState pState, Level pLevel, BlockPos pPos,
    ...
    if (!pState.getValue(POWERED)) {
      pLevel.getBlockTicks().scheduleTick(pPos, this, delay);
    }
  ...
  @Deprecated
  @Override
  public void tick(BlockState pState, ServerLevel pLevel, BlockPos pPos,
                   Random pRand) {
  ...
  @Override
  public int getSignal(BlockState pBlockState, BlockGetter pBlockAccess,
                       BlockPos pPos, Direction pSide) {
    int res = super.getSignal(pBlockState, pBlockAccess, pPos, pSide);
    return inverted ? 15 - res : res;
  }

  @Override
  public int getDirectSignal(BlockState pBlockState, BlockGetter pBlockAccess,
                             BlockPos pPos, Direction pSide) {
