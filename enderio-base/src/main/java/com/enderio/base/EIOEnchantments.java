...
public class EIOEnchantments {
	...
	// should crossbow and bow be handled as different enchant classes for the sake of levels/costs?
	...
	public static final TranslatableComponent REPELLENT_DESC = descriptionBuilder("repellent", "Chance to teleport attackers away\\nHigher levels teleport more often and farther");
	public static final TranslatableComponent SHIMMER_DESC  = descriptionBuilder("shimmer", "Makes the item shimmer as if it was enchanted.\\nThat's all.\\nReally.\\nNothing more.\\nYes, it is useless.\\nI know."); 
	public static final TranslatableComponent SOULBOUND_DESC = descriptionBuilder("soulbound", "Prevents item from being lost on death.\\nNote: Most gravestone mods are stupid and prevent this from working!");
	public static final TranslatableComponent WITHER_ARROW_DESC = descriptionBuilder("wither_bow", "Applies withering to the target\\nApplies to ranged weapons");
	public static final TranslatableComponent WITHER_WEAPON_DESC = descriptionBuilder("wither_weapon", "Applies withering to the target\\nApplies to melee weapons");
	...
	private static <T extends EIOBaseEnchantment> EnchantmentBuilder< T, Registrate> enchantmentBuilder(String name, T enchantment){
		return REGISTRATE
			.enchantment(name, enchantment.getCategory(), (r,c,s) -> enchantment);
	}
